...
- VTT 样例：`vYtDL-standalone/downloads_case/downloads_case/AI的正确打开方式：不学概念，学动作.zh.vtt` (类型 A)
- VTT 样例：`vYtDL-standalone/downloads_case/downloads_case/Game Theory #25：  Trump Visits China.en.vtt` (类型 B)
