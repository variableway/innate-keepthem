...
app.post("/api/start-download", async (c) => {
  ...
  const record = {
    ...
    collection_id: (typeof request.collection_id === "string" && request.collection_id.trim()) || null,
    collection_title: (typeof request.collection_title === "string" && request.collection_title.trim()) || null,
